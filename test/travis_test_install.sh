...
/usr/bin/python ${SRCROOT}/test/mapnik_stylesheets_generate_xml.py ${SRCROOT}/test/osm.xml /etc/mapnik-osm-data/custom.xml --dbname gis --user postgres --inc /etc/mapnik-osm-data/inc/
